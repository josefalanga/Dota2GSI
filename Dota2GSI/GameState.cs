...
namespace Dota2GSI
{
    ...
    public class GameState : Node
    {
        ...
        /// <summary>
        /// Constructs a node, tolerating malformed data.<br/>
        /// A single failing node must not kill the whole payload.
        /// </summary>
        /// <typeparam name="T">The node type to construct.</typeparam>
        /// <param name="create">Factory that builds the node from its json token.</param>
        /// <param name="fallback">Default-constructed node used when the factory throws.</param>
        /// <returns>The constructed node, or the default-constructed fallback on failure.</returns>
